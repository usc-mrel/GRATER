...
% waveform. Exp1 .mat files contain data for one averaged waveform or 
% waveform measurement. Exp1A .mat files contain data for 64 averages of 
% GRATER and OVS+GRATER with RGA=-G (see figure 3A of GRATER manuscript): 
%   1.  2 bands, TBW = 2
%   2.  2 bands, TBW = 4
%   3.  2 bands, TBW = 6
%   4.  2 bands, TBW = 8
...
% (see figure 3B of GRATER manuscript).
%
...
% (see figure 4 of GRATER manuscript).
...
%   (see figure 5 of GRATER manuscript).
% 
% Raw data files: 
%   1. exp2_grater.mat
